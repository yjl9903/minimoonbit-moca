...
test-riscv:
  ...
  ./run_riscv.sh test/test_src/id.mbt -o
  ./run_riscv.sh test/test_src/inprod-loop.mbt -o
  ./run_riscv.sh test/test_src/inprod-rec.mbt -o
  ./run_riscv.sh test/test_src/inprod.mbt -o
  ./run_riscv.sh test/test_src/join-reg.mbt -o
  ./run_riscv.sh test/test_src/join-reg2.mbt -o
  ./run_riscv.sh test/test_src/join-stack.mbt -o
  ./run_riscv.sh test/test_src/join-stack2.mbt -o
